...
export default function IngredientPage() {
    ...
    const handleSearch = async (ingredient) => {
        ...
        try {
            ...
            `https://api.nhk.or.jp/v2/pg/genre/130/e1/0205/2024-06-26.json?key=uy1Ny9L1WFB2F1sY6HGzZj933YbxkgpS${
        ...
        console.log(result);
        if (result && result.list && result.list.e1) {
            setData(result.list.e1);
        } else {
